        ...
        <div className="container flex flex-col justify-between py-10 mx-auto space-y-8 lg:flex-row lg:space-y-0">
          <div className="lg:w-1/3">
            <Link to={'/'} className="flex justify-center space-x-3 lg:justify-start">
              <div className="flex items-center justify-center w-12 h-12 rounded-full bg-slate-400">
                <MdDataThresholding className='text-4xl' />
              </div>
              <span className="self-center text-2xl font-semibold">OPINEX</span>
            </Link>
          </div>
